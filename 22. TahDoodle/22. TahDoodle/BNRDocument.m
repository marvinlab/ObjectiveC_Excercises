...
{
    // If there's no array yet, go ahead and create a new one to store our new task
    if (!todoItems) {
...
{
    // This table view is meant to display todoItems,
...
-(id)tableView:(NSTableView *)tableView
    objectValueForTableColumn:(NSTableColumn *)tableColumn
                          row:(NSInteger)row
{
    // Return the item frim todoItems that corresponds to the cell
                 ...
                 error:(NSError **)outError
{
    ...
    // so thay it can be written to disk
